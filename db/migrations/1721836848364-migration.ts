...
export class Migration1721836848364 implements MigrationInterface {
  name = 'Migration1721836848364';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "user" DROP CONSTRAINT "FK_758b8ce7c18b9d347461b30228d"`);
    await queryRunner.query(`ALTER TABLE "user" RENAME COLUMN "user_id" TO "user_type"`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "user" RENAME COLUMN "user_type" TO "user_id"`);
    await queryRunner.query(
