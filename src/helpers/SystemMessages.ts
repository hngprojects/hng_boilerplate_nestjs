...
export const CATEGORY_NOT_FOUND = 'Blog category not found';
export const BLOG_CATEGORY_FETCHED = 'Blog category retrieved successfully';
export const BLOG_CATEGORY_UPDATED = 'Blog category updated successfully';
