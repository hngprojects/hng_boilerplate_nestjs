  ...
  describe('getAllUsers', () => {
    ...
    describe('updateUserAttempts', () => {
      ...
      it('should update user attempts and time left successfully', async () => {
        ...
        jest.spyOn(mockUserRepository, 'findOne').mockResolvedValueOnce(existingUser);
        jest.spyOn(mockUserRepository, 'save').mockResolvedValueOnce(updatedUser);
