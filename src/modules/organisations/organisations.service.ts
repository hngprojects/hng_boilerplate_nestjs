...
import { ORG_EXISTS_ERROR, ORG_NOT_FOUND, ORG_UPDATE } from '../../helpers/SystemMessages';
...
export class OrganisationsService {
  ...
  async create(createOrganisationDto: CreateOrganisationType, userId: string) {
    if (createOrganisationDto.email) {
      ...
      if (emailFound) throw new CustomHttpException(ORG_EXISTS_ERROR, HttpStatus.CONFLICT);
    }
