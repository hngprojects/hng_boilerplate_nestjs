...
import { OrgRequestMockdto } from './tests/mocks/organisation-dto.mock';
...
describe('OrganisationsService', () => {
  ...
  describe('it should create an organisation', () => {
    beforeEach(async () => {
      const errors = await validate(OrgRequestMockdto);
    ...
    it('should create an organisation', async () => {
      ...
      const result = await service.create(OrgRequestMockdto, orgMock.owner.id);
  ...
  describe('error for an exsiting email', () => {
    ...
    it('should throw an error if the email already exists', async () => {
      ...
      await expect(service.create(OrgRequestMockdto, orgMock.owner.id)).rejects.toThrow(
